...
* Limits:
  ...
  * 100 character length limit of individual string values (NewRelic supports 4k but this library will truncate long strings automatically and add an ellipsis.)
